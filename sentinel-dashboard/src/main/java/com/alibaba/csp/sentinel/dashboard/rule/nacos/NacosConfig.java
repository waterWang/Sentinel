...
public class NacosConfig {
  ...
  public ConfigService nacosConfigService() throws Exception {
    ...
    props.put(PropertyKeyConst.SERVER_ADDR, DashboardConfig.getNacosServer());
    props.put(PropertyKeyConst.NAMESPACE, DashboardConfig.getNacosNamespace());
    props.put(PropertyKeyConst.USERNAME, DashboardConfig.getNacosUsername());
    props.put(PropertyKeyConst.PASSWORD, DashboardConfig.getNacosPassword());
